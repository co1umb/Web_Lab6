...
const first = document.getElementById('eleven');
...
first.addEventListener("mouseover", function() {
    eleven.style.backgroundColor = `rgb(${getRandom(0, 255)}, ${getRandom(0, 255)}, ${getRandom(0, 255)})`;
});

first.addEventListener("click", function() {
    eleven.style.backgroundColor= colorInput.value;
});
